...
**定義**: 写真を full-screen で表示し、横スワイプやズームで閲覧する UI。

**説明**: `EntryDetailScreen` の写真プレビューから開く全画面 viewer を指し、詳細画面の編集責務は増やさない。

**関連用語**: PhotoAsset, EntryDetailScreen

**使用例**:
- 写真をタップして Lightbox で細部を確認する
